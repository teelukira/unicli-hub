...
**Mandatory on start**: Read `hub/common/adr-conventions.md` before drafting any ADR. The ADR is SSOT for architecture decisions; this agent's outputs must conform exactly to Nygard + project metadata format.
