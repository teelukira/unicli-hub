...
transition_id_inprogress: "21"    # "Start Progress"  To Do → 진행중(In Progress)  [Code Generation Part 2]
transition_id_review: "111"       # "Resolve"  In Progress → 검토(Review)              [Build and Test 완료 후]
