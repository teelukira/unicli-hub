...
**Canonical rules:** read `hub/common/jira-integration.md` in full (sections 0 through 5 and failure handling).
...
**Description template SSOT:** `hub/templates/remotes/jira-issue.body.md` — render with `scripts/render-ai-dlc-remote-templates.py` (see `hub/templates/remotes/README.md`).
