...
EXACT_GUARDS: list[tuple[str, str]] = [
    ...
    (".claude/settings.json", "hub/registry/hook-events.json (regenerate: sync.sh)"),
    (".cursor/hooks.json", "hub/registry/hook-events.json (regenerate: sync.sh)"),
    (".agents/settings.json", "hub/registry/hook-events.json (regenerate: sync.sh)"),
