...
2. 로컬 E2E — Playwright로 로컬 환경(H2 + Vite dev) 브라우저 테스트
3. Dev-Light E2E — 배포된 ECS + CloudFront 환경 브라우저 테스트
...
```json
{
  ...
  "stages": [
    ...
    },
    {
      "name": "web-test",
      "role": "web-integration-tester",
      "prompt_template": "로컬+dev-light 웹 통합 테스트 실행해줘. E2E: frontend/e2e/"
    }
  ]
}
```
